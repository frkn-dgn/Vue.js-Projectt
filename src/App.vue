<template>
  <v-app>
    <v-navigation-drawer v-model="drawer" app clipped floting temporary>
      <v-list dense>
        <v-row class="ma-2 mb-3">
          <v-icon class="mx-4" large>mdi-video</v-icon>
          <v-toolbar-title class="align-center">
            <span class="title">FURKAN</span>
          </v-toolbar-title>
        </v-row>
    ...
    <v-app-bar app clipped-left>
      ...
      <v-icon class="mx-4" large>mdi-video</v-icon>
      <v-toolbar-title class="align-center">
        <span class="title">My Vue Project</span>
      </v-toolbar-title>
      <v-spacer />
      <v-text-field
        class="mt-6"
          ...
          <v-card>
            <v-list>
              <v-list-item>
                ...
                <v-list-item-content>
                  <v-list-item-title>Vue Project</v-list-item-title>
...
export default {
  ...
  data: () => ({
    items: [
      ...
      { icon: "mdi-youtube-subscription", text: "Follow Up" },
